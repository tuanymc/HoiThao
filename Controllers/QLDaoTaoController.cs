...
{
    public class QLDaoTaoController : Controller
    {
        ...
        {
            var tins = db.Tins.Include(t => t.LoaiTin).Include(t => t.NguoiDung).Where(x=>x.MaLT==11);
            return View(tins.ToList());
        }

        // GET: QLDaoTao/Details/5
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.MaLT = new SelectList(db.LoaiTins.Where(x => x.MaLT == 11), "MaLT", "TenLT", tin.MaLT);
            ViewBag.MaND = new SelectList(db.NguoiDungs, "MaND", "HT", tin.MaND);
            return View(tin);
        }

        // POST: QLDaoTao/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateInput(false)]
