...
{
    public class QLSlideController : Controller
    {
        ...
        {
            var slides = db.Slides.Include(s => s.LoaiSlide).Where(m => m.MaLoai == 1006).OrderByDescending(m => m.MaSlide);
        ...
        public ActionResult Create([Bind(Include = "MaSlide,MaLoai,TenSlide,LinkSide,MoTaSlide,Show")] Slide slide, string H)
        {
