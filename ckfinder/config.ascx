...
<%@ Import Namespace="KhoaXayDung.Models" %>
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        else
        {
            ...
            var id = Session["tendangnhap"].ToString();
            NguoiDung nd = db.NguoiDungs.FirstOrDefault(n => n.MaND == id);
            if (nd != null)
            {
                return true;
            }
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "toeictaigia";
        LicenseKey = "FNJ13GEL2FXDNELF53SYUL1T386UFBDU";
